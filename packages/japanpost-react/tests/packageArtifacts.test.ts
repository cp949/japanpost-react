    ...
    try {
      const typecheckStdout = runPackedConsumerTypecheck(
        ...
        [
          ...
          "} from \"@cp949/japanpost-react\";",
          "",
          "type RemoteAddressPage = {",
          "  entries: Array<Pick<JapanAddress, 'postalCode' | 'prefecture' | 'city' | 'town' | 'address'>>;",
          "  total: number;",
          "  pageNumber: number;",
          "  rowsPerPage: number;",
          "};",
          ...
          "",
          "const fetchOptions: JapanPostFetchDataSourceOptions = {",
          '  baseUrl: "https://example.com",',
          "  paths: {",
          '    lookupPostalCode: "/lookup-postal-code",',
          ...
          "    }",
          "",
          '    return path.includes("lookup") ? "invalid_postal_code" : "invalid_query";',
          "  },",
          "};",
          "",
          "const fetchDataSource: JapanAddressDataSource = createJapanPostFetchDataSource(fetchOptions);",
          "",
          "const apiClient: JapanPostApiClient<ApiContext, RemoteAddressPage> = {",
          "  async searchcode(request) {",
          '    const traceId = request.ctx?.traceId ?? "missing";',
          "",
          "    return {",
          "      entries: [",
          "        {",
          ...
          '          city: "Chiyoda-ku",',
          '          town: "Chiyoda",',
          "          address: `Tokyo Chiyoda-ku Chiyoda (${traceId})`,",
          "        },",
          "      ],",
          "      total: 1,",
          ...
          '          city: "Chiyoda-ku",',
          '          town: "Chiyoda",',
          "          address: request.addressQuery ?? `Tokyo Chiyoda-ku Chiyoda (${traceId})`,",
          "        },",
          "      ],",
          "      total: 1,",
          "      pageNumber: request.pageNumber,",
          ...
          "};",
          "",
          "const apiOptions: JapanPostApiDataSourceOptions<ApiContext, RemoteAddressPage> & {",
          "  mapPage: (page: RemoteAddressPage) => Page<JapanAddress>;",
          "} = {",
          "  createContext(options) {",
          "    return {",
          '      traceId: options?.signal ? "aborted" : "active",',
          "    };",
          "  },",
          "  mapPage(page) {",
          "    return {",
          "      elements: page.entries.map((entry) => ({",
          "        ...entry,",
          '        provider: "japan-post",',
          "      })),",
          ...
          "};",
          "",
          "const apiDataSource: JapanAddressDataSource = createJapanPostApiDataSource(apiClient, apiOptions);",
          "",
          "const postalRequest: JapanPostSearchcodeRequest = {",
          '  postalCode: "1000001",',
          "  pageNumber: 0,",
          "  rowsPerPage: 20,",
          "};",
          "",
          "const addressRequest: JapanPostAddresszipRequest = {",
          ...
          "};",
          "",
          "const displayText: string = formatJapanAddressDisplay(address);",
          "",
          ...
          "void fetchDataSource.lookupPostalCode(postalRequest);",
          "void fetchDataSource.searchAddress(addressRequest);",
          "void apiDataSource.lookupPostalCode(postalRequest);",
          "void apiDataSource.searchAddress(addressRequest);",
          "void displayText;",
          "void page;",
          "void normalized;",
          "void postalCode;",
